...
//deshabilita  estatus
router.put(
  "/NuevaOrdenCompra/ArchivosAdjuntosDisable/:id",
  disableOrcArchvivosAdj
);
...
//deshabilita  estatus
router.put(
  "/OrdenCompra/ArchivosAdjuntosDisable/:id",
  disableOrdenArchivosAdjuntos
);
...
//deshabilita  estatus
router.put(
  "/OrdenCompra/FoliosSurtidosDisable/:id",
  disableOrdenFoliosSurtidos
);
...
//deshabilita  estatus
router.put(
  "/OrdenCompra/ListadoEntradasDisable/:id",
  disableOrdenListadoEntrada
);
...
//Parcial  estatus
router.post(
  "/OrdenCompra/ListadoEntradasParcial/:id",
  parcialOrdenListadoEntrada
);
//Entregas  estatus
router.post(
  "/OrdenCompra/ListadoEntradasEntregas/:id",
  entregasOrdenListadoEntrada
);
//rutas  estatus
...
//Embarque  estatus
router.post(
  "/OrdenCompra/ListadoEntradasEmbarque/:id",
  embarqueOrdenListadoEntrada
);
//Embarque  estatus
router.post(
  "/OrdenCompra/ListadoEntradasSurtido/:id",
  surtidoOrdenListadoEntrada
);
...
//deshabilita  estatus
router.put(
  "/OrdenCompra/ProductosOrdenCompraDisable/:id",
  disableProductosOrdenCompra
);
...
//eliminar estatus
router.put(
  "/Agregar/ProductoRelacionadoDisable/:id",
  disableagregarProductoRelacionado
);

//actualizar estatus
router.put(
  "/Agregar/ProductoRelacionado/:id",
  updateagregarProductoRelacionado
);
...
router.get(
  "/historialProductoUltimasCompras",
  getAllhistorialProductoUltimasCompras
);

//ver un estatus
router.get(
  "/historialProductoUltimasCompras/:id",
  gethistorialProductoUltimasCompras
);
...
//eliminar estatus
router.put(
  "/historialProductoUltimasComprasDisable/:id",
  disablehistorialProductoUltimasCompras
);
...
router.get(
  "/historialProductoUltimasVentas",
  getAllhistorialProductoUltimasVentas
);

//ver un estatus
router.get(
  "/historialProductoUltimasVentas/:id",
  gethistorialProductoUltimasVentas
);
...
//eliminar estatus
router.put(
  "/historialProductoUltimasVentasDisable/:id",
  disablehistorialProductoUltimasVentas
);
...
router.get(
  "/inventarioGeneralReporteInventario",
  getAllinventarioGeneralReporteInventario
);

//ver un estatus
router.get(
  "/inventarioGeneralReporteInventario/:id",
  getinventarioGeneralReporteInventario
);
...
//eliminar estatus
router.put(
  "/inventarioGeneralReporteInventarioDisable/:id",
  disableinventarioGeneralReporteInventario
);
...
/////////////////////////////////////// RUTAS PARA INVENTARIO GENERAL REPORTE DE INVENTARIO
router.get(
  "/listadoProductosMargenProductos",
  getAlllistadoProductosMargenProductos
);

//ver un estatus
router.get(
  "/listadoProductosMargenProductos/:id",
  getlistadoProductosMargenProductos
);
...
//eliminar estatus
router.put(
  "/listadoProductosMargenProductosDisable/:id",
  disablelistadoProductosMargenProductos
);
...
//crear
router.post("/CreateMarcasProducto", upload.single("image"), createMarcasproducto);
...
router.get("/api/marcasImage/:id", getBrandImages);
...
//disable
router.put(
  "/ProductosSurtidosPedidoDisable/:id",
  disableProductosSurtidosPedido
);
