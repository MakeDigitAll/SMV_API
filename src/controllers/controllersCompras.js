...
const getAllOrcFoliosSur = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "nuevaOrdenCompraFoliosSurtido" WHERE "isDeleted" = '0'`
    );
...
const getOrcFoliosSur = async (req, res, next) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM "nuevaOrdenCompraFoliosSurtido" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "Esta tarea no existe en la base de datos o puede que este deshabilitada",
      });
...
const getAllOrcArchvivosAdj = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "nuevasOrdenesCompraArchivosAdjuntos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getOrcArchvivosAdj = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "nuevasOrdenesCompraArchivosAdjuntos" WHERE id = $1 AND "isDeleted" = '0'`,
      [id]
    );
...
const getAllOrdenArchivosAdjuntos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "ordenCompraArchivosAdjuntos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getOrdenArchvivosAdj = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "ordenCompraArchivosAdjuntos" WHERE id = $1 AND "isDeleted" = '0'`,
      [id]
    );
...
const getAllOrdenFoliosSurtidos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "ordenCompraFoliosSurtido" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getOrdenFoliosSurtidos = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "ordenCompraFoliosSurtido" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllOrdenListadoEntrada = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "ordenesCompraListadoEntradas" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getOrdenListadoEntrada = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "ordenesCompraListadoEntradas" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllProductosOrdenCompra = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosLaOrdenCompra" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getProductosOrdenCompra = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosLaOrdenCompra" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllListadoProduct = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoProductos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getListadoProduct = async (req, res) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "listadoProductos" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllProductos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getAllListadoProductDesc = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoProductosDescuento" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getListadoProductDesc = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "listadoProductosDescuento" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllagregarProductoRelacionado = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "agregarProductoRelacionado" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
...
const getagregarProductoRelacionado = async (req, res, next) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM "agregarProductoRelacionado" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllbuscarProducto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "buscarProducto" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getbuscarProducto = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "buscarProducto" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllcategoria = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "categoria" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getcategoria = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "categoria" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllcostoProductos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "costoProductos" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getcostoProductos = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "costoProductos" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllhistorialProducto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "historialProducto" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const gethistorialProducto = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "historialProducto" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllhistorialProductoUltimasCompras = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "historialProductoUltimasCompras" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const gethistorialProductoUltimasCompras = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "historialProductoUltimasCompras" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllhistorialProductoUltimasVentas = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "historialProductoUltimasVentas" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const gethistorialProductoUltimasVentas = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "historialProductoUltimasVentas" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllinventarioGeneralReporteInventario = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "inventarioGeneralReporteInventario" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getinventarioGeneralReporteInventario = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "inventarioGeneralReporteInventario" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAlllistadoProductosMargenProductos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoProductosMargenProductos" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getlistadoProductosMargenProductos = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "listadoProductosMargenProductos" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllTransMasProdTrans = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoTransferenciasMasivasProductosTransferencia"  WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getTransMasProdTrans = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "listadoTransferenciasMasivasProductosTransferencia" WHERE id = $1 AND "isDeleted"='0' `,
      [id]
    );
...
const disableTransMasProdTrans = async (req, res, next) => {
  ...
  if (result.rowCount === 0)
    return res.status(404).json({
      message:
        "La tarea no se pudo actualizar Listado Transferencias Masivas Productos Transferencia",
    });
...
const updateTransMasProdTrans = async (req, res, next) => {
  try {
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "La tarea no se pudo actualizar en Listado Transferencias Masivas Productos Transferencia",
      });
    res.json(result.rows[0]);
  } catch (error) {
    console.log("Error", error.message);
...
const getAllMarcasproducto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "marcasProducto" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getMarcasproducto = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "marcasProducto" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const createMarcasproducto = async (req, res, next) => {
  ...
  try {
    const { marca, catalogo, productos } = document;
    const result = await pool.query(
      `INSERT INTO public."marcasProducto"( marca, catalogo, productos, "isUpdated", "isDeleted", "DateCreation", "DateModification") VALUES ($1, $2, $3, '0' , '0', NOW() , NOW() ) RETURNING *`,
      [marca, catalogo, productos]
    );
    if (result.rows.length > 0) {
      const imagen = req.file.buffer;
      const result2 = await pool.query(
        `INSERT INTO public."marcasImages"("idMarca", imagen) VALUES ($1, $2) RETURNING *`,
        [result.rows[0].id, imagen]
      );
    }    
    res.json(result.rows[0]);  
  } catch (error) {
...
const getBrandImages = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(`SELECT * FROM "marcasImages" WHERE id = $1`, [
      id,
    ]);
    if (result.rows.length === 0)
      return res.status(404).json({
...
const getAllProductoscotizados = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosCotizados" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getAllProductosPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosPedido" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getProductosPedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosPedido" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllProductosRelacionados = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosRelacionados" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getProductosRelacionados = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosRelacionados" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllProductosSurtidosPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosSurtidosPedido" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getProductosSurtidosPedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosSurtidosPedido" WHERE id = $1 "isDeleted"= '0'`,
      [id]
    );
...
const disableProductosSurtidosPedido = async (req, res, next) => {
  ...
  if (result.rowCount === 0)
    return res.status(404).json({
      message:
        "La tarea no se pudo actualizar en la tabla Productos Surtidos Pedido",
    });
...
const getAllProductosSurtirPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosSurtirPedido" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getProductosSurtirPedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosSurtirPedido" WHERE id = $1 AND "isDeleted"= '0'`,
      [id]
    );
...
const createProductosSurtirPedido = async (req, res, next) => {
  const { codigo, nombre, cantidad, faltan, surtir, disponibles, series } =
    req.body;
...
const disableProductosSurtirPedido = async (req, res, next) => {
  ...
  if (result.rowCount === 0)
    return res.status(404).json({
      message:
        "La tarea no se pudo actualizar en la tabla Productos Surtir Pedido",
    });
...
const getAllProductosTransRecordProd = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "productosTransferencia" WHERE "isDeleted"='0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getProductosTransRecordProd = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "productosTransferencia" WHERE id= $1 AND "isDeleted"= '0'`,
      [id]
    );
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "La tarea no funciona en la tabla Productos Transferencia Record Productos",
      });
...
const updateProductosTransRecordProd = async (req, res, next) => {
  try {
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "La tarea no se pudo actualizar en la tabla Productos Transferencia Record Producto",
      });
...
const getAllRecordProducto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "recordProducto" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getRecordProducto = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "recordProducto" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllTransIndividual = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "transferenciaAlmacenesListadoIndividual" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getAllListadoEntradas = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoEntradas" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getAllListadoSalidas = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoSalida" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getAllMotivosEntrada = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "motivosEntrada" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getMotivosEntrada = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "motivosEntrada" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
const getAllSucursalesAlmacen = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "sucursalesAlmacenesListadoProductos" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const createSucursalesAlmacen = async (req, res, next) => {
  const { nombre, ciudad, estado, telefono, gerente, almacenes, web } =
    req.body;
...
const getSucursalesAlmacen = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "sucursalesAlmacenesListadoProductos" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "La tarea no funciona en la sucursales almacen listado productos",
      });
...
const updateSucursalesAlmacen = async (req, res, next) => {
  try {
    ...
    if (result.rows.length === 0)
      return res.status(404).json({
        message:
          "La tarea no se pudo actualizar en la tabla sucursales almacen listado productos",
      });
...
const getAllSucursalesDatos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "sucursalesDatos" WHERE "isDeleted"= '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error", error.message);
...
const getSucursalesDatos = async (req, res, next) => {
  try {
    const { id, isDeleted } = req.params;
    const result = await pool.query(
      `SELECT * FROM "sucursalesDatos" WHERE id = $1 AND "isDeleted"='0'`,
      [id]
    );
...
module.exports = {
  ...
  disableOrcFoliosSur,
  updateOrcFoliosSur,
  getAllOrcArchvivosAdj,
  getOrcArchvivosAdj,
  createOrcArchvivosAdj,
  disableOrcArchvivosAdj,
  updateOrcArchvivosAdj,
  getAllOrdenArchivosAdjuntos,
  getOrdenArchvivosAdj,
  createOrdenArchivosAdjuntos,
  disableOrdenArchivosAdjuntos,
  updateOrdenArchivosAdjuntos,
  getAllOrdenFoliosSurtidos,
  getOrdenFoliosSurtidos,
  createOrdenFoliosSurtidos,
  disableOrdenFoliosSurtidos,
  updateOrdenFoliosSurtidos,
  getAllOrdenListadoEntrada,
  getOrdenListadoEntrada,
  createOrdenListadoEntrada,
  disableOrdenListadoEntrada,
  updateOrdenListadoEntrada,
  parcialOrdenListadoEntrada,
  entregasOrdenListadoEntrada,
  rutasOrdenListadoEntrada,
  embarqueOrdenListadoEntrada,
  surtidoOrdenListadoEntrada,
  getAllListadoProduct,
  getListadoProduct,
  createListadoProduct,
  ...
  disableProducto,
  updateProducto,
  getAllProductosOrdenCompra,
  getProductosOrdenCompra,
  createProductosOrdenCompra,
  disableProductosOrdenCompra,
  updateProductosOrdenCompra,
  getAllListadoProductDesc,
  getListadoProductDesc,
  createListadoProductDesc,
  disableListadoProductDesc,
  updateListadoProductDesc,

  getAllagregarProductoRelacionado,
  getagregarProductoRelacionado,
  createagregarProductoRelacionado,
  updateagregarProductoRelacionado,
  disableagregarProductoRelacionado,
  getAllbuscarProducto,
  getbuscarProducto,
  createbuscarProducto,
  disablebuscarProducto,
  updatebuscarProducto,
  getAllcategoria,
  getcategoria,
  createcategoria,
  disablecategoria,
  updatecategoria,
  getAllcostoProductos,
  getcostoProductos,
  createcostoProductos,
  disablecostoProductos,
  updatecostoProductos,
  getAllhistorialProducto,
  gethistorialProducto,
  createhistorialProducto,
  disablehistorialProducto,
  updatehistorialProducto,
  getAllhistorialProductoUltimasCompras,
  gethistorialProductoUltimasCompras,
  createhistorialProductoUltimasCompras,
  disablehistorialProductoUltimasCompras,
  updatehistorialProductoUltimasCompras,
  getAllhistorialProductoUltimasVentas,
  gethistorialProductoUltimasVentas,
  createhistorialProductoUltimasVentas,
  disablehistorialProductoUltimasVentas,
  updatehistorialProductoUltimasVentas,
  getAllinventarioGeneralReporteInventario,
  getinventarioGeneralReporteInventario,
  createinventarioGeneralReporteInventario,
  disableinventarioGeneralReporteInventario,
  updateinventarioGeneralReporteInventario,
  getAlllistadoProductosMargenProductos,
  getlistadoProductosMargenProductos,
  createlistadoProductosMargenProductos,
  disablelistadoProductosMargenProductos,
  updatelistadoProductosMargenProductos,

  getAllTransMasProdTrans,
  getTransMasProdTrans,
  createTransMasProdTrans,
  disableTransMasProdTrans,
  updateTransMasProdTrans,
  getAllMarcasproducto,
  getMarcasproducto,
  createMarcasproducto,
  disableMarcasproducto,
  updateMarcasproducto,
  getAllProductoscotizados,
  getProductoscotizados,
  createProductoscotizados,
  disableProductoscotizados,
  updateProductoscotizados,
  getAllProductosPedido,
  getProductosPedido,
  createProductosPedido,
  disableProductosPedido,
  updateProductosPedido,
  getAllProductosRelacionados,
  getProductosRelacionados,
  createProductosRelacionados,
  disableProductosRelacionados,
  updateProductosRelacionados,
  getAllProductosSurtidosPedido,
  getProductosSurtidosPedido,
  createProductosSurtidosPedido,
  disableProductosSurtidosPedido,
  updateProductosSurtidosPedido,
  getAllProductosSurtirPedido,
  getProductosSurtirPedido,
  createProductosSurtirPedido,
  disableProductosSurtirPedido,
  updateProductosSurtirPedido,
  getAllProductosTransRecordProd,
  getProductosTransRecordProd,
  createProductosTransRecordProd,
  disableProductosTransRecordProd,
  updateProductosTransRecordProd,
  getAllRecordProducto,
  getRecordProducto,
  createRecordProducto,
  disableRecordProducto,
  updateRecordProducto,
  getAllTransIndividual,
  createTransIndividual,
  getAllListadoEntradas,
  getAllListadoSalidas,
  getAllMotivosEntrada,
  createMotivosEntrada,
  getMotivosEntrada,
  updateMotivosEntrada,
  createListadoEntradas,
  getAllSucursalesAlmacen,
  createSucursalesAlmacen,
  getSucursalesAlmacen,
  updateSucursalesAlmacen,
  disableSucursalesAlmacen,
  getSucursalesDatos,
  getAllSucursalesDatos,
  createSucursalesDatos,
  updateSucursalesDatos,
  disableSucursalesDatos,
  getBrandImages,
