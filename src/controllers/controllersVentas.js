...
const getAllPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "pedido" WHERE "isDeleted" = '0' `
    );
...
const getPedido = async (req, res, next) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM "pedido" WHERE idpedido = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllDetallePedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "detallePedido" WHERE "isDeleted  " = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getDetallePedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "detallePedido" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllFormasPagoPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "formasPagoPedido" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getFormasPagoPedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "formasPagoPedido" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllVerPedido = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "verPedido" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getVerPedido = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "verPedido" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllLogisticaPedidos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "logistcaPedidos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getLogisticaPedidos = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "logistcaPedidos" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllPedidosPendientesSurt = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "pedidosPendientesSurtir" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getPedidosPendientesSurt = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "pedidosPendientesSurtir" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const createPedidosPendientesSurt = async (req, res, next) => {
  const { folio, fecha, cliente, monto, estatus, factura, surtido, parcial } =
    req.body;
...
const getAllAgregarProveedor = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "agregarProvedor" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log("Error: ", error.message);
...
const getAgregarProveedor = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "agregarProvedor" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllProveedores = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "provedores" WHERE "isDelete" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
...
const getProveedores = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "provedores" WHERE id = $1 AND "isDelete" = '0' `,
      [id]
    );
...
const createProveedores = async (req, res, next) => {
  const { nombre, razonSocial, rfc, ciudad, estado, pais, productos } =
    req.body;
...
const getAllProveedoresProducto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "provedoresProducto" WHERE "isDelete" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getProveedoresProducto = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "provedoresProducto" WHERE id = $1 AND "isDelete" = '0' `,
      [id]
    );
...
const updateProveedoresProducto = async (req, res, next) => {
  const { id } = req.params;
  const { nombreProvedor, unidadesCompradas, ultimaCompra, creationUpdate } =
    req.body;
...
const getAllCotizaciones = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "cotizaciones" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getAllPedidos = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "pedidos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getPedidos = async (req, res, next) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM "pedidos" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllReporteComision = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "reporteComisiones" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getReporteComision = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "reporteComisiones" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllListadoClientes = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM public."clientes" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getListadoClientes = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "clientes" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getImageClient = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "clientes" WHERE "isDeleted" = '0'`,
      [id]
    );
    if (result.rows.length === 0)
      return res.status(404).json({
...
const getAllClientesFacturacion = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "fichaClienteFacturacion" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getClientesFacturacion = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "fichaClienteFacturacion" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllClientesContacto = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "fichaClienteContactos" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getClientesContacto = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "fichaClienteContactos" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const createClientesContacto = async (req, res, next) => {
  const { nombre, contacto, email, comentarios, ubicacion, apellido } =
    req.body;
...
const getAllClientesDireccionEnvio = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "fichaClienteDireccionesEnvio" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getClientesDireccionEnvio = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "fichaClienteDireccionesEnvio" WHERE "idCliente" = $1 AND "isDeleted" = '0' `,
      [id]
    );
    if (result.rows.length === 0)
      return res.status(404).json({
...
const getClientesAccesoWeb = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "fichaClienteAccesoWeb" WHERE id = $1`,
      [id]
    );
...
const getAllClientesEstadoCuenta = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM  "fichaClienteEstadoCuenta" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getClientesEstadoCuenta = async (req, res, next) => {
  try {
    const { id, isDelete } = req.params;
    const result = await pool.query(
      `SELECT * FROM "fichaClienteEstadoCuenta" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
...
const getAllListadoVendedores = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM "listadoVendedores" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
const getSellerImage = async (req, res, next) => {
  try {
    const { id } = req.params;
    const result = await pool.query(
      `SELECT * FROM "listadoVendedores" WHERE id = $1 AND "isDeleted" = '0' `,
      [id]
    );
    if (result.rows.length === 0)
      return res.status(404).json({
...
const updateListadoVendedores = async (req, res, next) => {
  ...
  const { nombre, telefono, sucursal, fechaAlta, referenciaWeb, clientes } =
    document;
...
const getAllCategorias = async (req, res, next) => {
  try {
    const allTasks = await pool.query(
      `SELECT * FROM public."categoria" WHERE "isDeleted" = '0'`
    );
    res.json(allTasks.rows);
  } catch (error) {
    console.log(error.message);
...
module.exports = {
  ...
  getDetallePedido,
  createDetallePedido,
  disableDetallePedido,
  updateDetallePedido,
  getAllFormasPagoPedido,
  getFormasPagoPedido,
  createFormasPagoPedido,
  disableFormasPagoPedido,
  updateFormasPagoPedido,
  getAllVerPedido,
  getVerPedido,
  createVerPedido,
  disableVerPedido,
  updateVerPedido,
  getAllLogisticaPedidos,
  getLogisticaPedidos,
  createLogisticaPedidos,
  disableLogisticaPedidos,
  updateLogisticaPedidos,
  getAllPedidosPendientesSurt,
  getPedidosPendientesSurt,
  createPedidosPendientesSurt,
  disablePedidosPendientesSurt,
  updatePedidosPendientesSurt,
  getAllAgregarProveedor,
  getAgregarProveedor,
  createAgregarProveedor,
  disableAgregarProveedor,
  updateAgregarProveedor,
  getAllProveedores,
  getProveedores,
  createProveedores,
  disableProveedores,
  updateProveedores,
  getAllProveedoresProducto,
  getProveedoresProducto,
  createProveedoresProducto,
  disableProveedoresProducto,
  updateProveedoresProducto,
  getAllReporteComision,
  getReporteComision,
  createReporteComision,
  disableReporteComision,
  updateReporteComision,
  getAllListadoClientes,
  getListadoClientes,
  createListadoClientes,
  disableListadoClientes,
  updateListadoClientes,
  getImageClient,
  updatePagos,
  PagosPendiente2,
  PagosPendiente1,
  ...
  getPagos,
  getAllPagos,
  getAllListadoVendedores,
  getListadoVendedores,
  createListadoVendedores,
  updateListadoVendedores,
  disableListadoVendedores,
  getSellerImage,
  getAllClientesFacturacion,
  getClientesFacturacion,
  createClientesFacturacion,
  disableClientesFacturacion,
  updateClientesFacturacion,
  getAllClientesContacto,
  getClientesContacto,
  createClientesContacto,
  disableClientesContacto,
  updateClientesContacto,
  getAllClientesDireccionEnvio,
  getClientesDireccionEnvio,
  createClientesDireccionEnvio,
  disableClientesDireccionEnvio,
  updateClientesDireccionEnvio,
  getAllClientesAccesoWeb,
  getClientesAccesoWeb,
  createClientesAccesoWeb,
  disableClientesAccesoWeb,
  updateClientesAccesoWeb,
  getAllClientesEstadoCuenta,
  getClientesEstadoCuenta,
  createClientesEstadoCuenta,
  disableClientesEstadoCuenta,
  updateClientesEstadoCuenta,
